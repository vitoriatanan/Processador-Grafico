...
//offset: 0b000010000
int set_sprite (int registrador, int x, int y, int offset, int activation_bit, volatile int* data_a, volatile int* data_b) {
    *data_a = (0x0000 << 4) | (registrador << 9);
    *data_b =  (offset << 9) | (y << 19) | ( x << 29) | (activation_bit << 30);
    return 1;
}
...
int main() {
    ...
    int registrador, x, y, offset, activation_bit;
    ...
    *start_ptr = 1; //ativa
    ...
    int set_sprite (0x00001, 0b0000000001, 0b0000000001, 0b000010000, 1, data_a_ptr, data_b_ptr);
